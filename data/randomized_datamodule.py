...
class RandomizedDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        binary_classification_config=None,  # Optional: Binary/ternary classification configuration
        model_config=None,  # Optional: Model configuration containing classification_mode
    ...
    def get_feature_dim(self) -> int:
        ...
        feature_columns = getattr(self.data_config, 'feature_columns', None)
        if feature_columns:
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        # Get binary classification config if available
        binary_classification_config = getattr(self, 'binary_classification_config', None)
        ...
        dataset = SimplifiedRandomDataset(
            ...
            binary_classification_config=binary_classification_config,

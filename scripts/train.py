...
def main():
    ...
    data_module = RandomizedDataModule(
        ...
        binary_classification_config=config.binary_classification,  # Pass classification config
        model_config=config.model  # Pass model config for classification_mode
    )
